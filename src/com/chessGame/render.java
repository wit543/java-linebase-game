...
public class render {
	public static void pagerefresh() throws FileNotFoundException, UnsupportedEncodingException{
       ...
       System.out.println("7 ║ "+grid.gridlayout[6][0]+grid.gridlayout[6][1]+grid.gridlayout[6][2]+grid.gridlayout[6][3]+grid.gridlayout[6][4]+grid.gridlayout[6][5]+grid.gridlayout[6][6]+grid.gridlayout[6][6]);     
       System.out.println("6 ║ "+grid.gridlayout[5][0]+grid.gridlayout[5][1]+grid.gridlayout[5][2]+grid.gridlayout[5][3]+grid.gridlayout[5][4]+grid.gridlayout[5][5]+grid.gridlayout[5][6]+grid.gridlayout[5][5]);     
       System.out.println("5 ║ "+grid.gridlayout[4][0]+grid.gridlayout[4][1]+grid.gridlayout[4][2]+grid.gridlayout[4][3]+grid.gridlayout[4][4]+grid.gridlayout[4][5]+grid.gridlayout[4][6]+grid.gridlayout[4][1]);     
